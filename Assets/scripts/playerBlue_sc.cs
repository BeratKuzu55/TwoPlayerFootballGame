...
public class playerBlue_sc : MonoBehaviour
{
    bool kontrol;
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        {
            Vector3 topa_vurus_vektoru = GameObject.Find("goalLeft").transform.position - GameObject.Find("ball").transform.position;
